(function () {
	...
	function activateAccount($state, $templateCache, $compile) {
		...
		var directive = {
			...
			link: link,
			templateUrl: 'modules/shared/account/forgotpassword/activate-account.tpl.html',
			scope: {
				state: '='
			},
			restrict: 'EA'
		...
		function link(scope, element, attr) {
			if (attr.state === 'resetpassword') {
				var template = $templateCache.get('modules/shared/account/forgotpassword/resetpassword.tpl.html');
